...
public class dificultadintermedia extends javax.swing.JDialog {
    ...
    /**
     * Creates new form dificultadintermedia
     */
...
//                        jButton12.setForeground(Color.pink);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dificultadintermedia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dificultadintermedia dialog = new dificultadintermedia(new javax.swing.JFrame(), true);
